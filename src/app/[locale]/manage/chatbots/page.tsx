...
import ChatbotTable from "@/app/[locale]/manage/chatbots/chatbot-table";
...
export async function generateMetadata(props: Props): Promise<Metadata> {
  ...
  const t = await getTranslations({
    ...
    namespace: "ManageChatbots",
  });

  const url = envConfig.NEXT_PUBLIC_URL + `/${params.locale}/manage/chatbots`;
...
export default async function ChatbotsPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const t = await getTranslations("ManageChatbots");
